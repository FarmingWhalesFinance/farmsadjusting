      ...
      <Container maxWidth="lg">
        <Grid container>
          ...
          <Grid item xs={6} style={{textAlign: 'right', height: '20px'}}>
            <a
              href="https://twitter.com/FarmingWhales"
            ...
            <a href="https://github.com/FarmingWhalesFinance" rel="noopener noreferrer" target="_blank" className={classes.link}>

          ...
          <Box mt={5}>
            <Grid container justify="center" spacing={3}>
                ...
                <Card className={classes.gridItem}>
                  <CardContent align="center">
                    <Typography style={{ textTransform: 'uppercase', color: '#f9d749' }}>
                      WHALE PEG <small>(TWAP)</small>
                    </Typography>
                    <Typography>{scalingFactor} USDC.e</Typography>
                    <Typography>
                      <small>per 1 WHALE</small>
                    </Typography>
                  </CardContent>
                </Card>
              </Grid>
              ...
              <Grid item xs={12} md={2} lg={2}>
                <Card className={classes.gridItem}>
                  <CardContent align="center">
                    <Typography style={{ textTransform: 'uppercase', color: '#f9d749' }}>WHALESHARES Staked</Typography>
